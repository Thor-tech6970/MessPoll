...
public class AlooMatarList extends AppCompatActivity {

    ListView listView;

    ArrayList<String> alooMatarHaters;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_aloo_matar_list);

        listView = findViewById(R.id.listView);

        alooMatarHaters = new ArrayList<>();

        arrayAdapter = new ArrayAdapter(this, android.R.layout.simple_expandable_list_item_1, alooMatarHaters);
