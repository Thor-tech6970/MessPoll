...
public class DalMakhaniList extends AppCompatActivity {

    ListView listView;

    ArrayList<String> dalMakhaniHaters;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dal_makhani_list);

        listView = findViewById(R.id.listView);
        dalMakhaniHaters = new ArrayList<>();
        arrayAdapter = new ArrayAdapter(this, android.R.layout.simple_expandable_list_item_1, dalMakhaniHaters);
