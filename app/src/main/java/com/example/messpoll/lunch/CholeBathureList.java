...
public class CholeBathureList extends AppCompatActivity {

    ListView listView;

    ArrayList<String> choleBathureHaters;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_chole_bathure_list);

        listView = findViewById(R.id.listView);
        choleBathureHaters = new ArrayList<>();
        arrayAdapter = new ArrayAdapter(this, android.R.layout.simple_expandable_list_item_1, choleBathureHaters);
