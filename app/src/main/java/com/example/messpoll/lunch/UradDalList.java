...
public class UradDalList extends AppCompatActivity {

    ListView listView;

    ArrayList<String> uradDalHaters;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_urad_dal_list);

        listView = findViewById(R.id.listView);

        uradDalHaters = new ArrayList<>();

        arrayAdapter = new ArrayAdapter(this, android.R.layout.simple_expandable_list_item_1, uradDalHaters);
