...
public class ChanaDalFryList extends AppCompatActivity {

    ListView listView;

    ArrayList<String> chanaDalFryHaters;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_chana_dal_fry_list);

        listView = findViewById(R.id.listView);

        chanaDalFryHaters = new ArrayList<>();

        arrayAdapter = new ArrayAdapter(this, android.R.layout.simple_expandable_list_item_1, chanaDalFryHaters);
