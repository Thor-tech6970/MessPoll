...
public class DumAlooList extends AppCompatActivity {

    ListView listView;
    ArrayList<String> dumAlooHaters;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dum_aloo_list);

        listView = findViewById(R.id.listView);

        dumAlooHaters = new ArrayList<>();

        arrayAdapter = new ArrayAdapter(this, android.R.layout.simple_expandable_list_item_1, dumAlooHaters);
