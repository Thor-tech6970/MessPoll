...
public class RajmaList extends AppCompatActivity {

    ListView listView;

    ArrayList<String> rajmaHaters;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_rajma_list);

        listView = findViewById(R.id.listView);

        rajmaHaters = new ArrayList<>();

        arrayAdapter = new ArrayAdapter(this, android.R.layout.simple_expandable_list_item_1, rajmaHaters);
