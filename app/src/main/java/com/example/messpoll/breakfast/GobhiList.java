...
public class GobhiList extends AppCompatActivity {

    ListView listView;
    ArrayList<String> gobhiParanthaHaters;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_gobhi_list);
        ...
        firebaseDatabase.getReference().child("Breakfast").child("GobhiParantha").addChildEventListener(new ChildEventListener() {
            ...
            public void onChildAdded(@NonNull DataSnapshot snapshot, @Nullable String previousChildName) {
                ...
                arrayAdapter = new ArrayAdapter(GobhiList.this, android.R.layout.simple_expandable_list_item_1, gobhiParanthaHaters);
