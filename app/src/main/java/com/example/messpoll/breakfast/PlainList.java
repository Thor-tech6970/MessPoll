...
public class PlainList extends AppCompatActivity {

    ListView listView;
    ArrayList<String> plainParanthaHaters;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        firebaseDatabase.getReference().child("Breakfast").child("PlainParantha").addChildEventListener(new ChildEventListener() {
            ...
            public void onChildAdded(@NonNull DataSnapshot snapshot, @Nullable String previousChildName) {
                ...
                arrayAdapter = new ArrayAdapter(PlainList.this, android.R.layout.simple_expandable_list_item_1, plainParanthaHaters);
