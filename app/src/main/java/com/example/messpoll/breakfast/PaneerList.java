...
public class PaneerList extends AppCompatActivity {

    ListView listView;
    ArrayList<String> paneerParanthaHaters;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_paneer_list);
        ...
        firebaseDatabase.getReference().child("Breakfast").child("PaneerParantha").addChildEventListener(new ChildEventListener() {
            ...
            public void onChildAdded(@NonNull DataSnapshot snapshot, @Nullable String previousChildName) {
                ...
                arrayAdapter = new ArrayAdapter(PaneerList.this, android.R.layout.simple_expandable_list_item_1, paneerParanthaHaters);
